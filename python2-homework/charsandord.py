# szó előfordulások száma az alábbi szövegben
import re
...
szoveg_kisbetu = TEXT.lower()
szoveg_tisztitas = re.split(',|"|\.|\n|\s', szoveg_kisbetu)
while '' in szoveg_tisztitas:
    szoveg_tisztitas.remove('')
# print(szoveg_tisztitas)


szotaram = {i: szoveg_tisztitas.count(i) for i in szoveg_tisztitas}
print(szotaram)
